...
export default ({onCollaborationDemandSent})=>{
  ...
  return (
    <div className="offer-element__collaborate-container">
      <button onClick={()=>setDisplayForm(!displayForm)} className="offer-element__collaborate-button">Répondre à cette annonce</button>
      {displayForm &&
                <form onSubmit={onSubmit} className="offer-element__comment-form offer-element__collaboration-form">
                  <textarea
