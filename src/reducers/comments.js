const commentsReducerDefaultState = {newCommentError:'',setCommentsError:'',comments: []}
...
const commentsReducer = (state=commentsReducerDefaultState,action)=>{
    ...
    switch(action.type){
        ...
        case 'NEW_COMMENT':
            ...
            return {newCommentError:'',comments:[...newFilteredState,{offer_id: action.id, comments : [action.comment,...associatedComments.comments]}]}
