  ...
  constructor (props) {
      ...
      if(useBrowserLocation) {
        if(navigator.geolocation) {
          navigator.geolocation.getCurrentPosition((position)=>{
            ...
            ).catch(()=>this.setState({error: 'Impossible de déterminer la position'}));
    ...
    onSubmit = (e)=> {
      ...
      if(!this.state.description ||
        !this.state.title || this.state.location.coordinates.length===0 || !this.state.scope) {
      ...
      return (
        ...
        <form className="offer-form__form" onSubmit={this.onSubmit}>
          ...
          {this.state.locationText&&
            <p>La position s&apos;affiche :
              <span className="settings__location-text">{this.state.locationText}</span></p>}
          ...
          <div className="offer-form__slider">
            <TippedSlider
              ...
              marks = {{
                1000: '1', 2000: '10', 3000: '100', 4000: '1000'
              }}
            />
          </div>
                    ...
                    <div>
                      ...
                      <div className="toggle-switch">
                        <input type="checkbox" checked={this.state.scope==='group'}
                          ...
                          name="toggleSwitchPublic"
                          id="toggleSwitchPublic" />
