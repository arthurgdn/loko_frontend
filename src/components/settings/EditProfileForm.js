...
import {
  startEditProfile, startSetProfile, startEditCompletedOffers
...
const EditProfileForm = ({
  ...
  const [completedOffers, setCompletedOffers] = useState(
    profile.completedOffers?profile.completedOffers:[]);
    ...
    if(profile.keywords) {
      for(const keyword of profile.keywords) {
        formattedKeywords.push({
          value: keyword.name, label: keyword.name, _id: keyword._id
        });
      }
    }
  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit} className="settings__form">
        ...
        <textarea
          className="settings__multilign"
          value={description}
          onChange={(e)=>setDescription(e.target.value)}
          placeholder="Decrivez vous rapidement ici"/>
        <p>Ce que vous recherchez :  </p>
        <textarea
          className="settings__multilign"
          value={summary}
          onChange={(e)=>setSummary(e.target.value)}
          placeholder="Expliquez ici ce que vous recherchez sur la plateforme..."></textarea>
