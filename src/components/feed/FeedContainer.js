...
const FeedContainer = ({
  feed, startSetFeed, setFeedError
})=>{
  ...
  return (
    <div className="content-container feed__container">
      {showingOffers.length===0? !error &&
                <p>Aucune annonces à afficher, ajoutez des centres d&apos;intérêts à votre profil,
                ou suivez d&apos;autres utilisateurs</p>
...
const mapDispatchToProps = (dispatch)=>({startSetFeed: ()=>dispatch(startSetFeed())});
