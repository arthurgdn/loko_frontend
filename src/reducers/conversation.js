const conversationReducerDefaultState = {setConversationError:'',editSpecificConversationError:''}
...
const conversationReducer = (state=conversationReducerDefaultState,action)=>{
    ...
    switch(action.type){
        ...
        case 'EDIT_SPECIFIC_CONVERSATION':
            return {...state,...action.updates,editSpecificConversationError:''}
        ...
        case 'EDIT_SPECIFIC_CONVERSATION_ERROR':
            return {...state,editSpecificConversationError:'Impossible de modifier les informations de la conversation'}
        default: 
            return state
    }
}
