...
import { startSetGroup } from '../../actions/groups';
import ManageGroup from './ManageGroup';
import GroupOffers from './GroupOffers';
import OfferForm from '../offers/OfferForm';
import { startAddOffer } from '../../actions/offers';
const GroupPage = ({
  history, match, stateGroup, startSetGroup, startAddOffer, addGroupOfferError, setGroupError
})=>{
  ...
  const sendMembershipRequest = ()=>{
    axios.post('/group/'+group._id+'/member')
      ...
      .catch(()=>setRequestError('Erreur lors de l\'envoi de la demande'));
  };
          ...
          <div className="group__content-display">
            <div className="profile__header">
              <img
                ...
                src={process.env.DEV_URL+'/group/'+group._id+'/image'}/>
                ...
                {group.securityStatus==='onRequest' || group.securityStatus==='open'
                  ?isRequested?<p><FaUserClock/> Demande envoyée</p>
                    :<button
                      ...
                      onClick={sendMembershipRequest}><GrUserAdd/> Rejoindre</button>
            ...
            <div className="group__body">
              ...
              {group.locationText &&
                <p className="profile__location"><GoLocation/> {group.locationText}</p>}
              ...
              <button
                ...
                onClick={()=>{setDisplayOfferForm(!displayOfferForm);}}
              ><RiAddCircleLine/> Publier dans le groupe</button>
