...
const ConversationsPage = ({
  ...
  const createConversation = ()=>{
    if(members.length===0) {
      setFrontNewConvError('Veuillez renseigner un membre');
    }else {
      ...
      <div className="content-container">
        <div className="group__page-container">
          <button
            ...
            onClick={()=>setDisplayNewConvForm(!displayNewConvForm)}
          ><AiOutlineMessage/>Nouvelle conversation</button>
          {displayNewConvForm &&
                        <div className="conversation__new-form">
                          ...
                          <button
                            ...
                            active={(members.length>0).toString()}>Démarrer</button>
